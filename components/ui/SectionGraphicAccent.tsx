      ...
      {section === 'experience' && (
        <div className="flex items-center gap-3 opacity-40 dark:opacity-30">
          <svg width="220" height="40" viewBox="0 0 220 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M 90,20 C 110,5 140,5 160,20" stroke="var(--accent)" strokeWidth="1.4" />
      ...
      {section === 'projects' && (
        <div className="flex items-center gap-3 opacity-50 dark:opacity-40">
          <svg width="240" height="45" viewBox="0 0 240 45" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <text x="102" y="28" fontSize="7.5" fontFamily="monospace" fill="var(--accent)" fontWeight="bold">API Route</text>
      ...
      {section === 'skills' && (
        <div className="flex items-center gap-3 opacity-40 dark:opacity-30">
          <svg width="200" height="40" viewBox="0 0 200 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <circle cx="140" cy="20" r="6" stroke="var(--accent)" strokeWidth="1.6" />
            <text x="137" y="23" fontSize="8" fontFamily="monospace" fill="var(--accent)">✦</text>
      ...
      {section === 'certifications' && (
        <div className="flex items-center gap-3 opacity-40 dark:opacity-30">
          <svg width="180" height="40" viewBox="0 0 180 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M 14,20 L 18,24 L 27,15" stroke="var(--accent)" strokeWidth="1.6" />
      ...
      {section === 'github' && (
        <div className="flex items-center gap-3 opacity-40 dark:opacity-30">
          <svg width="220" height="40" viewBox="0 0 220 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <circle cx="160" cy="20" r="4.5" fill="var(--accent)" />
      ...
      {section === 'contact' && (
        <div className="flex items-center gap-3 opacity-50 dark:opacity-40">
          <svg width="220" height="40" viewBox="0 0 220 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <circle cx="140" cy="20" r="4" fill="var(--accent)" />
