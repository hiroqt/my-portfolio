...
import { FaArrowRight, FaTrophy, FaRunning, FaClock, FaExternalLinkAlt } from 'react-icons/fa'
...
const featuredProjects = [
  {
    ...
    summary: 'Awarded Best Business Impact at the Amazon Quick Quest Workshop in BGC, Taguig. Enterprise financial operations platform automating expense review cycles, invoice-to-PO reconciliation, and real-time policy compliance via Amazon Quick Spaces & Flows.',
              ...
              <div className="lg:col-span-5">
                ...
                >
                  <img
                    ...
                    className={`w-full h-52 sm:h-72 object-cover ${project.imagePosition || 'object-top'}`}
                    loading="lazy"
                  />
