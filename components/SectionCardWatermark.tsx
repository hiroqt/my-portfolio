...
interface SectionCardWatermarkProps {
  variant: 'education' | 'experience-1' | 'experience-2' | 'skills' | 'certifications' | 'contact'
  className?: string
}
...
export function SectionCardWatermark({ variant, className = '' }: SectionCardWatermarkProps) {
  return (
    ...
    >
      ...
      {/* 04 — Skills: Neural Constellation Mesh */}
      {variant === 'skills' && (
      ...
      {/* 05 — Certifications: Verified Rosette Stamp */}
